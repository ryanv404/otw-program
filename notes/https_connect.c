...
void
parse_url(char *url, char **hostname, char **port, char** path)
{
    printf("URL: %s\n", url);
...
void
send_request(SSL *s, char *hostname, char *port, char *path)
{
    char buffer[2048];
...
SOCKET
connect_to_host(char *hostname, char *port)
{
